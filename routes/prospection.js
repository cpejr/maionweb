          ...
          Budget.getById(req.params.budget_id).then((budget)=>{
            ...
            //console.log(req.session);
                  for (var i = 0; i < client.companionFullname.length; i++) {
                    ...
                    res.render('prospection/pageD', { title: 'Geral Page D', layout: 'layoutDashboard.hbs',  client_id: req.params.client_id, budget_id: req.params.budget_id, client, budget, companions0, test0});
            }).catch((error) => {
                //console.log(error);
                res.redirect('/error');
              });
...
router.get('/pageE/:client_id/:budget_id', function(req, res) {
  Client.getById(req.params.client_id).then((client) => {
      Budget.getById(req.params.budget_id).then((budget)=>{
        ...
        //console.log(req.session);
                res.render('prospection/pageE', { title: 'Geral Page E', layout: 'layoutDashboard.hbs', client_id: req.params.client_id,  budget_id: req.params.budget_id, client, budget, ...req.session, companions1, test1});
            }).catch((error) => {
                //console.log(error);
                res.redirect('/error');
              });
      ...
      Budget.getById(req.params.budget_id).then((budget)=>{
        ...
        //console.log(req.session);
              for (var i = 0; i < client.companionFullname.length; i++) {
                ...
                //console.log(req.session);
                res.render('prospection/pageF', { title: 'Geral Page F', layout: 'layoutDashboard.hbs', client_id: req.params.client_id,  budget_id: req.params.budget_id, client, budget, ...req.session, companions2, test2});
            }).catch((error)=>{
                //console.log(error);
                res.redirect('/error');
              });
        ...
        //console.log(req.session);
              for (var i = 0; i < client.companionFullname.length; i++) {
                ...
                //console.log(test3[i]);
                    ...
                    //console.log(req.session);
                    res.render('prospection/pageG', { title: 'Geral Page G', layout: 'layoutDashboard.hbs', client_id: req.params.client_id,  budget_id: req.params.budget_id, client, budget, ...req.session, companions3, test3});
                }).catch((error)=>{
                    //console.log(error);
                    res.redirect('/error');
                  });
                ...
                Budget.getAssociatedCarById(req.params.budget_id).then((cars)=>{
                  Budget.getAssociatedSafeById(req.params.budget_id).then((safes)=>{
                          ...
                          //console.log(flights);
                                        ...
                                        res.render('prospection/pageH', { title: 'Geral Page H', layout: 'layoutDashboard.hbs', client_id: req.params.client_id,  budget_id: req.params.budget_id, budget, client, ...req.session, companions, test, infoTraslado, traslado, infoCarros, carros, infoSeguro, seguro, infoTickets, tickets, infoOutros, outros, hoteis, infoHoteis});
                                    }).catch((error)=>{
                                        //console.log(error);
                                        res.redirect('/error');
                                      });
...
router.post('/pageA',(req,res) => {
  ...
  // if (client.email == client.email1) {
    Client.create(client).then((client_id) => {
      ...
      //console.log(client);
      res.redirect(`/prospection/pageB/${client_id}`);
    }).catch((error) => {
    console.log(error);
    console.log('------------------------');
    ...
    res.redirect('/prospection/pageA');
  });
});
                    ...
                    Safe.create(safe).then((safe_id) => {
                      Budget.addSafe(budget_id, safe_id).then(() => {
                        Budget.update(budget_id, motherClient).then(() => {
                          res.redirect(`/prospection/pageD/${client_id}/${budget_id}`);
                        }).catch((error) =>{
                          console.log(error);
                          res.redirect('error');
                        });
...
router.post('/pageD/:client_id/:budget_id',(req,res) => {
  ...
  Budget.getById(req.params.budget_id).then((budget) => {
    Flight.update(budget.flights, flight).then(() => {
      res.redirect(`/prospection/pageE/${client_id}/${budget_id}`);
    }).catch((error) => {
      //console.log(error);
      res.redirect('error');
    });
...
router.post('/pageE/:client_id/:budget_id',(req,res) => {
  ...
  Budget.getById(budget_id).then((budget) => {
    Hotel.update(budget.hotels, hotel).then(() => {
      res.redirect(`/prospection/pageF/${client_id}/${budget_id}`);
    }).catch((error) => {
      //console.log('budget');
      //console.log(error);
      res.redirect('error');
...
router.post('/pageF/:client_id/:budget_id',(req,res) => {
  ...
  Budget.getById(budget_id).then((budget) => {
    Car.update(budget.cars, car).then(() => {
      res.redirect(`/prospection/pageG/${client_id}/${budget_id}`);
    }).catch((error) => {
      //console.log(error);
      res.redirect('error');
    });
...
router.post('/pageG/:client_id/:budget_id',(req,res) => {
  ...
  Budget.getById(budget_id).then((budget) => {
    Safe.update(budget.safes, safe).then(() => {
      res.redirect(`/prospection/pageH/${client_id}/${budget_id}`);
    }).catch((error) => {
      //console.log(error);
      res.redirect('error');
    });
