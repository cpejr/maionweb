...
$("#add-hotel").click(function() {
  $("#landing-hotel-col1").append(' <div class="box_hotel_ldateFromeft"> <br><br><br><br><br><br><br><br><br><br><br> <div class="classa"> <input class="form-control" placeholder="Tipo de acomodação" name="hotel[acomodationType1]" required> </div><br> <div class="classa"> <input class="form-control" placeholder="Hotel 1" name="hotel[hotel1]" required> </div><br> <div class="classa"> <input class="form-control" placeholder="N. de Pessoas" name="hotel[qntd1]" required> </div><br> <div class="classa"> <input class="form-control" placeholder="Categoria do Apartamento" name="hotel[category1]" required> </div><br> <div class="classa"> <select placeholder="Selecione" class="form-control" name=hotel[food1] required> <option style="display:none">Regime de Alimentação</option> <option>Com Café da Manhã</option> <option>Sem Café da Manhã</option> <option>Pensão Completa</option> <option>Outros</option> </select> </div><br> <div class="classa"> <input class="form-control" placeholder="Valor Apto" name="hotel[valueApt1]" id="vApto1" required> </div><br> <div class="classa"> <input class="form-control" placeholder="Número de diárias" name="hotel[numberDaily1]" id="nDiarias1" required> </div><br> <div class="classa"> <input class="form-control" placeholder="Número de Apartamentos" name="hotel[numberApt1]" id="nAptos1" onblur="vHoteis1()" required> </div><br> <div class="classa"> <input class="form-control" placeholder="Total" name="hotel[total1]" id="vTotal1" required> </div><br> <div class="classa"> <select class="form-control" name="hotel[cancellationPeriod]" required> <option style="display:none">Prazo de Cancelamento</option> <option>Sem prazo</option> <option>Com prazo</option> <option>Outro</option> </select> </div> </div>');
  $("#landing-hotel-col2").append('  <div class="box_hotel_midle"> <div class="classa"> <input class="form-control" placeholder="Cidade 1" name="hotel[city]" required> </div><br> <div class="classa"> <input class="form-control" placeholder="Tipo de acomodação" name="hotel[acomodationType2]" required> </div><br> <div class="classa"> <input class="form-control" placeholder="Hotel 2" name="hotel[hotel2]" required> </div><br> <div class="classa"> <input class="form-control" placeholder="N. de Pessoas" name="hotel[qntd2]" required> </div><br> <div class="classa"> <input class="form-control" placeholder="Categoria do Apartamento" name="hotel[category2]" required> </div><br> <div class="classa"> <select placeholder="Selecione" class="form-control" name=hotel[food2] required> <option style="display:none">Regime de Alimentação</option> <option>Com Café da Manhã</option> <option>Sem Café da Manhã</option> <option>Pensão Completa</option> <option>Outros</option> </select> </div><br> <div class="classa"> <input class="form-control" placeholder="Valor Apto" name="hotel[valueApt2]" id="vApto2" required> </div><br> <div class="classa"> <input class="form-control" placeholder="Número de diárias" name="hotel[numberDaily2]" id="nDiarias2" required> </div><br> <div class="classa"> <input class="form-control" placeholder="Número de Apartamentos" name="hotel[numberApt2]" id="nAptos2" onblur="vHoteis2()" required> </div><br> <div class="classa"> <input class="form-control" placeholder="Total" name="hotel[total2]" id="vTotal2" required> </div><br> <div class="classa"> <select class="form-control" name="hotel[cancellationPeriod2]" required> <option style="display:none">Prazo de Cancelamento</option> <option>Sem prazo</option> <option>Com prazo</option> <option>Outro</option> </select> </div> <label>Moeda utilizada:</label> <div id="companion_camp" > <select placeholder="Selecione" class="form-control" name=hotel[coin] required> <option style="display:none">Selecione qual moeda:</option> <option>$</option> <option>R$</option> <option>€</option> </select> </div><br><br> </div>');
  $("#landing-hotel-col3").append('  <div class="box_hotel_right"><br><br><br><br><br><br><br><br><br><br> <div class="classa"> <input class="form-control" placeholder="Tipo de acomodação" name="hotel[acomodationType3]" required> </div><br> <div class="classa"> <input class="form-control" placeholder="Hotel 3" name="hotel[hotel3]" required> </div><br> <div class="classa"> <input class="form-control" placeholder="N. de Pessoas" name="hotel[qntd3]" required> </div><br> <div class="classa"> <input class="form-control" placeholder="Categoria do Apartamento" name="hotel[category3]" required> </div><br> <div class="classa"> <select placeholder="Selecione" class="form-control" name=hotel[food3] required> <option style="display:none">Regime de Alimentação</option> <option>Com Café da Manhã</option> <option>Sem Café da Manhã</option> <option>Pensão Completa</option> <option>Outros</option> </select> </div><br> <div class="classa"> <input class="form-control" placeholder="Valor Apto" name="hotel[valueApt3]" id="vApto3" required> </div><br> <div class="classa"> <input class="form-control" placeholder="Número de diárias" name="hotel[numberDaily3]" id="nDiarias3" required> </div><br> <div class="classa"> <input class="form-control" placeholder="Número de Apartamentos" name="hotel[numberApt3]" id="nAptos3" onblur="vHoteis3()" required> </div><br> <div class="classa"> <input class="form-control" placeholder="Total" name="hotel[total3]" id="vTotal3" required> </div><br> <div class="classa"> <select class="form-control" name="hotel[cancellationPeriod3]" required> <option style="display:none">Prazo de Cancelamento</option> <option>Sem prazo</option> <option>Com prazo</option> <option>Outro</option> </select> </div> </div>');
  numcity++;
  numhotel++;
});
// page E - FIM
...
$("#add_translado").click(function(){
  ...
  $("#PageF_Col2").append('      <div class="boxRightPageF"> <div> <h3> Traslado 1</h3><br> <input name="car[from]" type="text" placeholder="De" class="date start-date" required/> <i class="fa fa-car" aria-hidden="true"></i> <input name="car[to]" type="text" placeholder="Para" class="date start-date" required/> <br><br> <input name="car[dateFrom]" type="date" placeholder="dd/mm/aa" class="date start-date" required/> <i class="fa fa-calendar"></i> <input name="car[timeFrom]" type="text" placeholder="Horário" class="date start-date" required/> <br><br> <input name="car[timeFrom]" type="text" placeholder="N. de Pessoas" class="date start-date" required/> </div> <h3>Informações/ Valores</h3><br> <div class="container rowclass classF-input"> <div class="row rowclass"> <div class="col-sm rowclass"> <div class="classa rowclass col-lg-11"> <input name="car[valueADT]" class="form-control" placeholder="ADT" required> </div> </div> <div class="col-sm rowclass"> <div class="classa rowclass col-lg-11"> <input name="car[valueCHD]" class="form-control" placeholder="CHD" required> </div> </div> <div class="col-sm rowclass"> <div class="classa rowclass col-lg-11"> <input name="car[valueINF]" class="form-control" placeholder="INF" required> </div><br> </div> <div class="col-sm rowclass"> <input name="car[totalTranslado]" class="form-control" placeholder="Total" required> </div> <div class="col-sm rowclass"> <select placeholder="Selecione" class="form-control form-control--espacoesq" name=car[coinT] required> <option style="display:none">Moeda:</option> <option>$</option> <option>R$</option> <option>€</option> </select> </div> </div> </div> </div>');
  pageFNumTranslado++;
});
$("#add_car").click(function(){
  $("#PageF_Col3").append('  <div class="boxCarsPageF"> <br><br><h3> Carros '+pageFNumCar+' </h3><br> <div class="classa"> <select placeholder="Selecione" class="form-control" name=car[coinC] required> <option style="display:none">Moeda:</option> <option>$</option> <option>R$</option> <option>€</option> </select> </div><br> <div class="classa"> <input class="form-control" placeholder="Categoria" name="car[typeCar]" required> </div><br> <div class="classa"> <input class="form-control" placeholder="Cidade de Retirada" name="car[withdrawal]" required> </div><br> <div class="classa"> <input class="form-control" placeholder="Cidade de Devolução" name="car[delivery]" required> </div><br> <div class="classa"> <input class="form-control" placeholder="Valor carro 1" name="car[totalCar]" required> </div><br> <div class="classa"> <input class="form-control" placeholder="Cidade" name="car[city]" required> </div><br> <div class="classa"> <input class="form-control" placeholder="Características" name="car[shift]" required> </div><br> <div class="classa"> <input class="form-control" placeholder="Seguros" name="car[safe]" required> </div><br> <div class="classa"> <input class="form-control" placeholder="Outros" name="car[others]" required> </div><br> </div>');
  pageFNumCar++;
});
// Page F - FIM
