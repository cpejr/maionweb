...
$( "#add-filhos" ).click(function() {
  $( "#familypageA" ).append('<br><br><div class="container rowclass"> <div class="row rowclass"> <div class="col-sm pageA-padding"> <div class="classa"> <label>Nome do/a filho/a</label> <input type="sondaughter" name = "client[children]" class="form-control" id="children" placeholder="Filho/a"> </div><br> <label for="">Data de nascimento</label> <div class="classa"> <input type="date" name = "client[birthDateChildren]" class="form-control" id="birthDateChildren" placeholder="Data de Nascimento"  > </div><br> </div> <div class="col-sm pageA-padding"> <div class="classa"> <label>Passaporte do/a filho/a</label> <input type="fullname" name = "client[childrenPassport]" class="form-control" id="childrenPassport" placeholder="Passaporte"> </div><br> <label for="">Validade do passaporte</label> <div class="classa"> <input type="date" name = "client[childrenPassportValidation]" class="form-control" id="childrenPassportValidation" placeholder="Validade Passaporte" > </div><br> </div> </div> </div>');
});



$( "#add-companion" ).click(function(){
  $( "#acompanhantespageA").append('<div class="container rowclass"> <div class="row rowclass"> <div class="col-sm pageA-padding"> <div class="classa"> <label>Nome do/a acompanhante</label> <input type="fullname" name = "client[companionFullname]" class="form-control" id="companionFullname" placeholder="Nome Completo"> </div><br> <div class="classa"> <label>Email do/a acompanhante</label> <input type="fullname" name = "client[companionEmail]" class="form-control" id="companionEmail" placeholder="Email"> </div><br> <label for="">Data de nascimento</label> <div class="classa"> <input type="date" name = "client[birthDateCompanion]" class="form-control" id="birthDateCompanion" placeholder="Data de Nascimento" > </div><br> </div> <div class="col-sm pageA-padding"> <div class="classa"> <label>Celular do/a acompanhante</label> <input type="fullname" name = "client[companionCellphone]" class="form-control" id="companionCellphone" placeholder="Celular"> </div><br> <div class="classa"> <label>Passaporte do/a acompanhante</label> <input type="fullname" name = "client[companionPassport]" class="form-control" id="companionPassport" placeholder="Passaporte"> </div><br> <label for="">Validade do passaporte</label> <div class="classa"> <input type="date" name = "client[companionPassportValidation]" class="form-control" id="companionPassportValidation" placeholder="Validade Passaporte" > </div><br> </div> </div> </div>');
...
$("#add-hotel").click(function() {
  ...
  $("#landing-hotel-col1").append('<div class="box_hotel_left box_hotel_left_selected" id="col-left'+numhotel+'"> <div class="rowclass"> <br><br><br><br><br><br><br> <div class="classa"> <div class="classa"> <label>Hotel 1</label> <input class="form-control" placeholder="Hotel 1" name="hotel[hotel1]" > </div><br> <div class="classa"> <label>Número de pessoas</label> <input class="form-control" placeholder="Número de Pessoas" name="hotel[qntd1]" value="0"> </div><br> <label>Tipo de acomodação</label> <input class="form-control" placeholder="Tipo de acomodação" name="hotel[acomodationType1]" > </div><br> <div class="classa"> <label>Categoria do Apartamento</label> <input class="form-control" placeholder="Categoria do Apartamento" name="hotel[category1]" > </div><br> <div class="classa"> <label>Regime de Alimentação</label> <select placeholder="Selecione" class="form-control" name=hotel[food1] > <option>Com Café da Manhã</option> <option selected>Sem Café da Manhã</option> <option>Pensão Completa</option> <option>Meia pensão</option> <option>All inclusive</option> <option>Outros</option> </select> </div><br> <div class="classa"> <label>Valor apto:</label> <input class="form-control" placeholder="Valor Apto" name="hotel[valueApt1]" id="vApto1'+numhotel+'" onblur="calcHotel()" value="0"> </div><br> <div class="classa"> <label>Número de diárias</label> <input class="form-control" placeholder="Número de diárias" name="hotel[numberDaily1]" id="nDiarias1'+numhotel+'" onblur="calcHotel()" value="0"> </div><br> <div class="classa"> <label>Número de apartamentos</label> <input class="form-control" placeholder="Número de Apartamentos" name="hotel[numberApt1]" id="nAptos1'+numhotel+'" onblur="calcHotel()" value="0"> </div><br> <div class="classa"> <label>Total Hotel 1</label> <input class="form-control" placeholder="Total" name="hotel[total1]" id="vTotal1'+numhotel+'" onblur="calcHotel()" value="0"> </div><br> <div class="classa"> <label>Prazo de Cancelamento</label> <select class="form-control" name="hotel[cancellationPeriod]" > <option selected>Sem prazo de cancelamento</option> <option>Com prazo de cancelamento</option> <option>Outro</option> </select> </div> </div> </div>');
  $("#landing-hotel-col2").append('<div class="box_hotel_midle box_hotel_midle_selected" id="col-middle'+numhotel+'"> <div class="rowclass marginEcolumNPR"> <h1>Cidade '+numhotel+'</h1> <div class="classa"> <input class="form-control" placeholder="Cidade 1" name="hotel[city]" > </div><br> <div class="classa"> <label>Hotel 2</label> <input class="form-control" placeholder="Hotel 2" name="hotel[hotel2]" > </div><br> <div class="classa"> <label>Número de pessoas</label> <input class="form-control" placeholder="Número de Pessoas" name="hotel[qntd2]" value="0"> </div><br> <div class="classa"> <label>Tipo de acomodação</label> <input class="form-control" placeholder="Tipo de acomodação" name="hotel[acomodationType2]" > </div><br> <div class="classa"> <label>Categoria de Apartamento</label> <input class="form-control" placeholder="Categoria do Apartamento" name="hotel[category2]" > </div><br> <div class="classa"> <label>Regime de Alimentação</label> <select placeholder="Selecione" class="form-control" name=hotel[food2] > <option>Com Café da Manhã</option> <option selected>Sem Café da Manhã</option> <option>Pensão Completa</option> <option>Meia pensão</option> <option>All inclusive</option> <option>Outros</option> </select> </div><br> <div class="classa"> <label>Valor apto:</label> <input class="form-control" placeholder="Valor Apto" name="hotel[valueApt2]" id="vApto2'+numhotel+'" onblur="calcHotel()" value="0"> </div><br> <div class="classa"> <label>Número de diárias</label> <input class="form-control" placeholder="Número de diárias" name="hotel[numberDaily2]" id="nDiarias2'+numhotel+'" onblur="calcHotel()" value="0"> </div><br> <div class="classa"> <label>Número de apartamentos</label> <input class="form-control" placeholder="Número de Apartamentos" name="hotel[numberApt2]" id="nAptos2'+numhotel+'" onblur="vHoteis2()" onblur="calcHotel()" value="0"> </div><br> <div class="classa"> <label>Total Hotel 2</label> <input class="form-control" placeholder="Total" name="hotel[total2]" id="vTotal2'+numhotel+'" onblur="calcHotel()" value="0"> </div><br> <div class="classa"> <label>Prazo de Cancelamento</label> <select class="form-control" name="hotel[cancellationPeriod2]" > <option selected>Sem prazo de cancelamento</option> <option>Com prazo de cancelamento</option> <option>Outro</option> </select> </div> <label class="moeda">Moeda utilizada:</label> <div id="companion_camp" > <select placeholder="Selecione" class="form-control" name=hotel[coin] ><option>USD</option> <option selected>R$</option> <option>€</option> </select> </div><br><br> </div> </div>');
  $("#landing-hotel-col3").append('<div class="box_hotel_right box_hotel_right_selected" id="col-right'+numhotel+'"> <div class="rowclass"> <br><br><br><br><br><br><br> <div class="classa"> <label>Hotel 3</label> <input class="form-control" placeholder="Hotel 3" name="hotel[hotel3]" > </div><br> <div class="classa"> <label>Número de pessoas</label> <input class="form-control" placeholder="Número de Pessoas" name="hotel[qntd3]" value="0"> </div><br> <div class="classa"> <label>Tipo de acomodação</label> <input class="form-control" placeholder="Tipo de acomodação" name="hotel[acomodationType3]" > </div><br> <div class="classa"> <label>Categoria do Apartamento</label> <input class="form-control" placeholder="Categoria do Apartamento" name="hotel[category3]" > </div><br> <div class="classa"> <label>Regime de Alimentação</label> <select placeholder="Selecione" class="form-control" name=hotel[food3] > <option>Com Café da Manhã</option> <option selected>Sem Café da Manhã</option> <option>Pensão Completa</option> <option>Meia pensão</option> <option>All inclusive</option> <option>Outros</option> </select> </div><br> <div class="classa"> <label>Valor apto:</label> <input class="form-control" placeholder="Valor Apto" name="hotel[valueApt3]" id="vApto3'+numhotel+'" onblur="calcHotel()" value="0"> </div><br> <div class="classa"> <label>Número de diárias</label> <input class="form-control" placeholder="Número de diárias" name="hotel[numberDaily3]" id="nDiarias3'+numhotel+'" onblur="calcHotel()" value="0"> </div><br> <div class="classa"> <label>Número de apartamentos</label> <input class="form-control" placeholder="Número de Apartamentos" name="hotel[numberApt3]" id="nAptos3'+numhotel+'" onblur="calcHotel()" value="0"> </div><br> <div class="classa"> <label>Total Hotel 3</label> <input class="form-control" placeholder="Total" name="hotel[total3]" id="vTotal3'+numhotel+'" onblur="calcHotel()" value="0"> </div><br> <div class="classa"> <label>Prazo de Cancelamento</label> <select class="form-control" name="hotel[cancellationPeriod3]" > <option selected>Sem prazo de cancelamento</option> <option>Com prazo de cancelamento</option> <option>Outro</option> </select> </div> </div> </div>');
...
$("#add_car").click(function(){
  numCar++;
  $("#landing_car").append('<div class="boxCarsPageF"> <br><br><h3> Carros '+numCar+' </h3><br> <div class="classa"><label style="margin-left: -90%">Categoria</label><input class="form-control" placeholder="Categoria" name="car[typeCar]" > </div><br> <div class="classa"><label style="margin-left: -82%">Local de Retirada</label><input class="form-control" placeholder="Local de Retirada" name="car[withdrawal]" > </div><br> <div class="classa"><label style="margin-left: -80%">Local de Devolução</label> <input class="form-control" placeholder="Local de Devolução" name="car[delivery]" > </div><br> <div class="classa"><label style="margin-left: -84%">Valor do carro '+numCar+'</label> <input class="form-control" placeholder="Valor do carro'+" "+numCar+'" name="car[totalCar]" ></div><br><div class="classa"><label style="margin-left: -85%">Características</label><input class="form-control" placeholder="Características" name="car[shift]" > </div><br> <div class="classa"><label style="margin-left: -91%">Seguros</label> <input class="form-control" placeholder="Seguros" name="car[safe]" > </div><br> <div class="classa"><label style="margin-left: -92%">Outros</label> <input class="form-control" placeholder="Outros" name="car[others]" > </div><br><div class="classa"><label style="margin-left: -92%">Moeda</label> <select placeholder="Selecione" class="form-control" name=car[coinC] > <option>USD</option> <option selected>R$</option> <option>€</option> </select> </div><br> </div>');
});
